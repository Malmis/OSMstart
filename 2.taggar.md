...
Att tagga - och tagga rätt - är alltså en stor och viktig del av kartarbetet. Det kan låta krångligt att behöva lära sig en massa olika taggar, men det behöver du inte. Kart-redigeraren på OpenStreetMap förenklar det hela och där väljer du färdiga kartobjekt så fixar redigeraren taggarna i bakgrunden.
